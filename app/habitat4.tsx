...
const LEVELS = [
  { id: 1,  x: 0.07, y: 0.79, asset: require('@/assets/images/habitat4_lvl/lvl_31.png'),  route: '/habitat5'  },
  { id: 2,  x: 0.08, y: 0.47, asset: require('@/assets/images/habitat4_lvl/lvl_32.png'),  route: '/level2'  },
  { id: 3,  x: 0.27, y: 0.38, asset: require('@/assets/images/habitat4_lvl/lvl_33.png'),  route: '/level3'  },
  { id: 4,  x: 0.37, y: 0.64, asset: require('@/assets/images/habitat4_lvl/lvl_34.png'),  route: '/level4'  },
  { id: 5,  x: 0.50, y: 0.71, asset: require('@/assets/images/habitat4_lvl/lvl_35.png'),  route: '/level5'  },
  { id: 6,  x: 0.55, y: 0.35, asset: require('@/assets/images/habitat4_lvl/lvl_36.png'),  route: '/level6'  },
  { id: 7,  x: 0.76, y: 0.47, asset: require('@/assets/images/habitat4_lvl/lvl_37.png'),  route: '/level7'  },
  { id: 8,  x: 0.70, y: 0.70, asset: require('@/assets/images/habitat4_lvl/lvl_38.png'),  route: '/level8'  },
  { id: 9,  x: 0.84, y: 0.79, asset: require('@/assets/images/habitat4_lvl/lvl_39.png'),  route: '/level9'  },
  { id: 10, x: 0.93, y: 0.54, asset: require('@/assets/images/habitat4_lvl/lvl_40.png'),  route: '/level10' },
]

// separate save file per habitat
const STORAGE_PATH = FileSystem.documentDirectory + 'unlockedLevels4.json'
...
export default function LevelSelect() {
  ...
  const bgPlayer = useVideoPlayer(
    require('@/assets/images/home/habitat4.mp4'),
    (p) => {
      p.loop = true
      p.muted = true
      p.play()
  ...
  useEffect(() => {
    startMusic('habitat4Music')
    return () => stopMusic('habitat4Music')
  }, [])
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.tipsWrapper} pointerEvents="none">
          <ExpoImage
            source={require('@/assets/images/habitat4_lvl/lvl4_tips.png')}
        ...
        <View style={styles.barWrapper} pointerEvents="box-none">
          <ExpoImage
            source={require('@/assets/images/habitat4_lvl/lvl4_bar.png')}
            style={styles.barImg}
            contentFit="contain"
          />
          <TouchableOpacity
        ...
        <View style={styles.menuCol}>
          ...
          >
            <ExpoImage
              source={require('@/assets/images/habitat4_lvl/lvl4_scoutpass.png')}
          ...
          >
            <ExpoImage
              source={require('@/assets/images/habitat4_lvl/lvl4_settings.png')}
              style={styles.menuBtnImg}
              contentFit="contain"
            />
          </TouchableOpacity>
          ...
          >
            <ExpoImage
              source={require('@/assets/images/habitat4_lvl/lvl4_menu.png')}
              style={styles.menuBtnImg}
              contentFit="contain"
            />
          </TouchableOpacity>
        ...
        <View style={styles.navRow} pointerEvents="box-none">
          ...
          >
            <ExpoImage
              source={require('@/assets/images/habitat4_lvl/lvl4_leftarrow.png')}
          ...
          <ExpoImage
            source={require('@/assets/images/habitat4_lvl/lvl4_nav.png')}
            style={styles.navImg}
            contentFit="contain"
            pointerEvents="none"
          />
          ...
          >
            <ExpoImage
              source={require('@/assets/images/habitat4_lvl/lvl4_rightarrow.png')}
              style={styles.arrowImg}
              contentFit="contain"
            />
          </TouchableOpacity>
