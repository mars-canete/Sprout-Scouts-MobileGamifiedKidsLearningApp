...
const LEVELS = [
  { id: 1,  x: 0.07, y: 0.79, asset: require('@/assets/images/habitat2_lvl/habitat2_lvl11.png'), route: '/puzzle' },
  { id: 2,  x: 0.08, y: 0.47, asset: require('@/assets/images/habitat2_lvl/habitat2_lvl12.png'), route: '/level2' },
  { id: 3,  x: 0.27, y: 0.38, asset: require('@/assets/images/habitat2_lvl/habitat2_lvl13.png'), route: '/level3' },
  { id: 4,  x: 0.34, y: 0.64, asset: require('@/assets/images/habitat2_lvl/habitat2_lvl14.png'), route: '/level4' },
  { id: 5,  x: 0.50, y: 0.71, asset: require('@/assets/images/habitat2_lvl/habitat2_lvl15.png'), route: '/level5' },
  { id: 6,  x: 0.55, y: 0.35, asset: require('@/assets/images/habitat2_lvl/habitat2_lvl16.png'), route: '/level6' },
  { id: 7,  x: 0.76, y: 0.47, asset: require('@/assets/images/habitat2_lvl/habitat2_lvl17.png'), route: '/level7' },
  { id: 8,  x: 0.70, y: 0.70, asset: require('@/assets/images/habitat2_lvl/habitat2_lvl18.png'), route: '/level8' },
  { id: 9,  x: 0.84, y: 0.79, asset: require('@/assets/images/habitat2_lvl/habitat2_lvl19.png'), route: '/level9' },
  { id: 10, x: 0.93, y: 0.54, asset: require('@/assets/images/habitat2_lvl/habitat2_lvl20.png'), route: '/level10' },
]

// separate save file per habitat
const STORAGE_PATH = FileSystem.documentDirectory + 'unlockedLevels2.json'
...
export default function LevelSelect() {
  ...
  const bgPlayer = useVideoPlayer(
    require('@/assets/images/home/habitat2bg.mp4'),
    (p) => {
      p.loop = true
      p.muted = true
      p.play()
  ...
  useEffect(() => {
    startMusic('habitat2Music')
    return () => stopMusic('habitat2Music')
  }, [])
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.tipsWrapper} pointerEvents="none">
          <ExpoImage
            source={require('@/assets/images/habitat2_lvl/lvl2_tips.png')}
        ...
        <View style={styles.barWrapper} pointerEvents="box-none">
          <ExpoImage
            source={require('@/assets/images/habitat2_lvl/lvl2_bar.png')}
            style={styles.barImg}
            contentFit="contain"
          />
          <TouchableOpacity
        ...
        <View style={styles.menuCol}>
          ...
          >
            <ExpoImage
              source={require('@/assets/images/habitat2_lvl/lvl_2scoutpass.png')}
          ...
          >
            <ExpoImage
              source={require('@/assets/images/habitat2_lvl/lvl2_settings.png')}
              style={styles.menuBtnImg}
              contentFit="contain"
            />
          </TouchableOpacity>
          ...
          >
            <ExpoImage
              source={require('@/assets/images/habitat2_lvl/lvl2_menu.png')}
              style={styles.menuBtnImg}
              contentFit="contain"
            />
          </TouchableOpacity>
        ...
        <View style={styles.navRow} pointerEvents="box-none">
          ...
          >
            <ExpoImage
              source={require('@/assets/images/habitat2_lvl/lvl2_leftarrow.png')}
          ...
          <ExpoImage
            source={require('@/assets/images/habitat2_lvl/lvl2_nav.png')}
            style={styles.navImg}
            contentFit="contain"
            pointerEvents="none"
          />
          ...
          >
            <ExpoImage
              source={require('@/assets/images/habitat2_lvl/lvl2_rightarrow.png')}
              style={[styles.arrowBtn]}
              contentFit="contain"
            />
          </TouchableOpacity>
